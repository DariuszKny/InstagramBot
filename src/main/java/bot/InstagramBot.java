...
public class InstagramBot {
    ...
    public final static String ALLOWBUTTON = "/html/body/div[4]/div/div/div[3]/button[2]";
    public final static String NIE_TERAZ_BUTTON = "/html/body/div[1]/section/main/div/div/div/div/button";
    public final static String HEARTBUTTON = "//span[contains(@class, 'fr66n')]/button[contains(@class, 'wpO6b ')]/*[local-name()='svg' and @class='_8-yf5 ' and @fill='#262626']";
